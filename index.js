...
*/
  console.log('task 1b:',createMenuItem('bacon',7,'Breakfast'));
  console.log('task 1b:',createMenuItem('steak',10,'Dinner'));
  console.log('task 1b:',createMenuItem('root beer',5,'Drinks'));
...
*/
function updateKey(array,index,key,value) {
  array[index][key] = value;
  return array;
}
console.log('task 4:',updateKey(reviews,7,'feedback','This place is chill with really cool people, great for getting work done on weekends'));
...
console.log('task 5:',addReview(reviews,'Raf',10,'This place is awesome!!! Great food!!!'));
...
function getLastReview(array) {
  return `${array[array.length-2].name} gave the restaurant a ${array[array.length-2].rating} star review, and their feedback was: ${array[array.length-2].feedback}`;
} 
